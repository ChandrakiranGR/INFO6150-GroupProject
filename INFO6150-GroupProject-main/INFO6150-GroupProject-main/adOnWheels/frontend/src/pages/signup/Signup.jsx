...
import { Container, Form, Button, Card, InputGroup, FormControl, Alert, ButtonGroup, Row, Col } from 'react-bootstrap';
import './Signup.css'
...
const Signup = () => {
  ...
  return (
    <Container className="d-flex justify-content-center mt-5">
      <Card style={{ width: '28rem' }} className="p-4">
        <h2 className="text-primary fw-bold text-center mb-4">Signup Form</h2>
        {showSuccess && (
        ...
        <Form onSubmit={handleSubmit}>
          <Form.Group className="mb-3" controlId="firstName">
            ...
            <Form.Text className="text-muted">Enter your first name (2-10 characters).</Form.Text>
          </Form.Group>
          ...
          <Form.Group className="mb-3" controlId="lastName">
            ...
            <Form.Text className="text-muted">Enter your last name (2-10 characters).</Form.Text>
          </Form.Group>
